...
- [x] Downloadable PDF audit report endpoint is available for active runs.
- [x] AI token/cost/latency telemetry is visible in the proof strip and impact dashboard.
- [x] Dedicated impact dashboard compares portfolio MTTR and $30/hour human cost.
- [x] Endpoint Security exception scenario proves safe rejection/no execution.
...
- [x] Playwright browser E2E suite passes.
